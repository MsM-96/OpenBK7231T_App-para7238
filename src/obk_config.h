...
#define ENABLE_I2C
#define ENABLE_DRIVER_BATTERY
#define ENABLE_DRIVER_SM16703P
#define ENABLE_DRIVER_PIXELANIM
#define ENABLE_DRIVER_SM15155E
#define ENABLE_DRIVER_DHT
#define ENABLE_DRIVER_AHT2X
#define ENABLE_DRIVER_IR
#define ENABLE_DRIVER_DS1820
#define ENABLE_DRIVER_CHT83XX
#define ENABLE_DRIVER_KP18058
#define ENABLE_DRIVER_ADCSMOOTHER
#define

#if (OBK_VARIANT == OBK_VARIANT_TUYAMCU || OBK_VARIANT == OBK_VARIANT_IRREMOTEESP || OBK_VARIANT == OBK_VARIANT_SENSORS || OBK_VARIANT == OBK_VARIANT_BATTERY || PLATFORM_BK7252 || PLATFORM_BK7252N || PLATFORM_BK7238)
#undef ENABLE_DRIVER_BL0937
#undef ENABLE_DRIVER_BL0942
